...
const uploadQuest = async (questId, zipFile) => {
  ...
  const body = new node_fetch__WEBPACK_IMPORTED_MODULE_0__.FormData();
  //body.append("file", "@quest.zip;type=application/x-zip-compressed")
  body.append('file', node_fetch__WEBPACK_IMPORTED_MODULE_0___default().fileFromSync('quest.zip;type=application/x-zip-compressed'));
